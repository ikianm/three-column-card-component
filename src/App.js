...
function App() {
  return (
    <div id='wrapper'>
      ...
      <Section name='LUXURY' desc='Cruise in the best car brands without the bloated prices. Enjoy the enhanced comfort of a luxury rental & arrive in style.' id='lux-btn' bg='hsl(179, 100%, 13%)' img='./images/icon-luxury.svg' />
    </div>
  );
}
